...
$sqlorders= "SELECT * FROM `orders` WHERE customer ='$username'";
$resultorders= mysqli_query($con, $sqlorders);
$numorders=mysqli_num_rows($resultorders); 
...
<body onload="initClock()">
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./dashboardcustomer.php" class="active">
                    <span class="material-symbols-outlined">dashboard</span>
                    <h3>Overview</h3>    
                </a>
                <a href="./productscustomer.php">
                    <span class="material-symbols-outlined">category</span>
                    <h3>Products</h3> 
                </a>
                <a href="./orderscustomer.php">
                    <span class="material-symbols-outlined">order_approve</span>
                    <h3>Orders</h3> 
                </a>
                <a href="./reviewscustomer.php">
        ...
        <main>
            ...
            <div class="insights">
                <div class="student-population">
                    ...
                    <small class="text-muted">total number of products on sale</small>
                </div>
                ...
                <div class="teaching-population">
                    ...
                    <small class="text-muted">total number of orders placed</small>
                </div>
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives an overview of your account</h2>
                            <h1></h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">have an overview of what is happening</small>
                </div>
                <!-- end of student population -->
            ...
            <div class="recent">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `products` ORDER BY id DESC";
                        $resultdisplay= mysqli_query($con, $sqldisplay);
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                $id=$rowdisplay['id'];
                                $name=$rowdisplay['name'];
                                $brand=$rowdisplay['brand'];
                                $price=$rowdisplay['price'];
                                $category=$rowdisplay['category'];
                                ...
                                <tr>
                                    ...
                                    <td>$price</td>
                                    <td>$category</td>
                                    <td><button id='view'  onclick=\"location.href = 'orderproduct.php?viewid=".$id."'\">Order</button></td>
                                </tr>
                ...
                <a href="./studentscustomer.php">Show All</a>
            </div>
        </main>
        <!-- end of main -->
        <div class="right">
            <div class="top">
                ...
                <div class="profile" onclick="location.href='./customerprofile.php'">
                    <div class="info">
                        <p>Hello, <b><?php echo $username; ?></b></p>   
                        <small class="text-muted"><?php echo $position; ?></small>
                    </div>
                    <div class="profile-photo">
                        <img src="../adminimages/dinner.jpg" alt="">
                    </div>
                </div>
            </div>
