...
$brand=$rowview['brand'];
$price=$rowview['price'];
$category=$rowview['category'];
$image=$rowview['image'];
$stock=$rowview['stock'];
$date=$rowview['date_added'];
...
if(isset($_POST['submit'])){
    if(empty($_POST['quantity'])){
        $error="specify quantity of product";
    }
    if($_POST['quantity'] > $stock){
        $error="order quantity is more than quantity in stock";
    }
    else{
        ...
        $sqlinsert= "INSERT INTO `orders` (name,quantity,total_price,status,review,customer,telephone) VALUES ('$name','$quantity','$total_price','Pending','','$username','$telephone')";
...
<body onload="initClock()"> 
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./dashboardcustomer.php">
                    <span class="material-symbols-outlined">dashboard</span>
                    <h3>Overview</h3>    
                </a>
                <a href="./productscustomer.php" class="active">
        ...
        <main>
            ...
            <h2>Enter Order Specification</h2>
            ...
            <div class="form-format"> 
                ...
                <div class="info-section">
                    <h2 class="form-legend">Product Information</h2>
                    <div class="info">
                        <p id="infos"><strong><?php echo $name;?></strong></p>
                        <p>Name</p>
                    </div>
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $brand;?></strong></p>
                        <p>Brand</p>
                    </div>   
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo "¢".$price.".00";?></strong></p>
                        <p>Price Per Product</p>
                    </div>  
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $category;?></strong></p>
                        <p>Category</p>
                    </div>   
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $stock;?></strong></p>
                        <p>Amount In Stock</p>
                    </div>                     
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $date;?></strong></p>
                        <p>Date Added</p>
                    </div>
                </div>
                ...
                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Order Information</h2>
                        <div class="form-divisions">
                            <input type="number" name="quantity" id="quantity" placeholder="enter quantity to order"  min="1"  value=<?php echo $quantity;?>>                      
                        </div>
                    ...
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./productscustomer.php'">Cancel</button>
                        </div>
                </div>
            </div>
    ...
    <script>
        ...
        function checkInputs(){
            ...
            if(quantityValue === ''){
                //show error
                //add error class
                setErrorFor(quantity, 'Enter quantity of product');
            }
            else{
                //add success class
