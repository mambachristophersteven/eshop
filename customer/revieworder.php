...
if(isset($_POST['submit'])){
    $order_review=$_POST['review'];


    $sqlinsert= "UPDATE `orders` SET id='$id', review='$order_review' WHERE id = '$id'";
    $resultin= mysqli_query($con, $sqlinsert);
    if($resultin){
        header("location: ./reviewscustomer.php");
        exit;
    }
    else{
            ...
            <div class="form-format"> 
                <div class="info-section">
                    ...
                    <div class="info">
                        ...
                        <p>Manager's Reply To Review</p>
                    </div>                
                </div>

                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Order Review Section</h2>
                    ...
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./reviewscustomer.php'">Cancel</button>
                        </div>
                </div>
            </div>
