...
$sqlorders= "SELECT * FROM `orders` WHERE customer ='$username' AND status='Approved'";
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./reviewscustomer.php" class="active">
        ...
        <main>
            ...
            <div class="insights">
                <div class="student-population">
                    ...
                    <small class="text-muted">total number of orders</small>
                </div>
                ...
                <div class="teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Give reviews about your orders</h2>
                            <h1>Review Info</h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">submit reviews here</small>
                </div>
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of orders with reviews permission</h2>
                            <h1></h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">search through records of reviews</small>
                </div>
                <!-- end of student population -->
            ...
            <div class="recent">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `orders` WHERE customer='$username' AND status='Approved' ORDER BY id DESC";
                        ...
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                ...
                                <tr>
                                    ...
                                    <td>$total_price</td>
                                    <td>$status</td>
                                    <td><button id='view'  onclick=\"location.href = 'revieworder.php?viewid=".$id."'\">Review</button></td>
                                </tr>
