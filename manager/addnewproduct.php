...
if(isset($_POST['submit'])){
    ...
    if(in_array($imagefilenameextension,$extensions)){
        ...
        $sqlinsert= "INSERT INTO `products` (name,brand,price,category,stock,image,date_added) VALUES ('$name','$brand','$price','$category','$stock','$upload_image','$currentDate')";
...
<head>
    ...
    <title>Shoppa - Manager</title>
    <link rel="icon" type="image/png" sizes="32x32" href="../logos/shop.png">
    <link rel="stylesheet" href="../css/addnewteacherheadmas.css">
    ...
    <div class="container">
        <aside>
            <div class="top">
                <div class="logo">
                    <div class="ring"></div> 
                    <img src="../logos/shop.png" alt="logo">
                    <h2 class="logo-name">Shoppa</span></h2>
                </div>
            ...
            <div class="sidebar">
                ...
                <a href="./productsmanager.php" class="active">
                    <span class="material-symbols-outlined">category</span>
                    <h3>Products</h3> 
                </a>
                <a href="./customersmanager.php">
                    <span class="material-symbols-outlined">group</span>
                    <h3>Customers</h3> 
                </a>
                <a href="./ordersmanager.php">
                    <span class="material-symbols-outlined">order_approve</span>
                    <h3>Orders</h3> 
                </a>
                <a href="./reviewsmanager.php">
        ...
        <main>
            ...
            <div class="form-format">              
                <div class="form">
                    <form action="./addnewproduct.php" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Standard Information</h2>
                        <div class="wrapper">
                            <div class="image-container">
                                <img src="../developerimages/image.png" alt="upload image" id="person-image">
                            </div>
                            <label for="image">
                        ...
                        <div class="form-divisions">
                            <input type="text" name="name" id="name" placeholder="enter name of product" value=<?php echo $name;?>>                     
                        </div>
                        <div class="form-divisions">
                            <input type="text" name="brand" id="brand" placeholder="enter brand of product" value=<?php echo $brand;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="number" name="price" id="price" placeholder="enter price of product" min="1" max="10000000" value=<?php echo $price;?>>
                        </div>
                        <div class="select-input-group">
                            <h4 class="select-heading">select category of product</h4>
                            <div class="form-control">
                                <select name="category" id="category">
                                    <option value=""></option>
                                    <option value="Headmaster">Electronics</option>
                                    <option value="Groceries">Grocies</option>
                        ...
                        <div class="form-divisions">
                            <input type="number" name="stock" id="stock" placeholder="enter number of products in stock" min="1" value=<?php echo $stock;?>>
                        </div>
                    ...
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./productsmanager.php'">Cancel</button>
                        </div>
                </div>
            </div>
        ...
        <div class="right">
            <div class="top">
                ...
                <div class="profile" onclick="location.href='./Managerprofile.php'">
                    <div class="info">
                        <p>Hello, <b><?php echo $username; ?></b></p>   
                        <small class="text-muted"><?php echo $position; ?></small>
                    </div>
                    <div class="profile-photo">
                        <img src="../adminimages/admin.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="recent-updates">
                ...
                <div class="updates">
                    <div class="update">
                        ...
                        <div class="message">
                           <p><b>Erica Baduwaa</b> has placed order for 15 cartons of milk</p>
                    ...
                    <div class="update">
                        ...
                        <div class="message">
                            <p><b>Martha Kusi</b> has placed order for 15 cartons of milk/p>
                            <small class="text-muted">10 minutes ago</small>
                        </div>
                    </div>
                    <div class="update">
                        ...
                        <div class="message">
                            <p><b>Elsie Ayeley</b> has placed order for 15 cartons of milk</p>
                           <small class="text-muted">10 minutes ago</small>
                        </div>
                    </div>
            ...
            <div class="notes-section">
                ...
                <div class="notes">
                    <div class="note">
                        <p>Deliver package to Dankwa at Dansoman</p>
                    </div>
                    <div class="note">
                        <p>Deliver package to Dankwa at Dansoman</p>
                    </div>
    ...
    <script>
        ...
        function checkInputs(){
            ...
            if(stockValue === ''){
                //show error
                //add error class
                setErrorFor(stock, 'Enter stock amount of product');
            }
            else{
                //add success class
                setSuccessFor(stock);
            ...
            if(categoryValue === ''){
                //show error
                //add error class
                setErrorFor(category, 'Select category of product');
            }
            else{
                //add success class
            ...
            if(priceValue === ''){
                //show error
                //add error class
                setErrorFor(price, 'Enter price of product');
            }
            else{
                //add success class
                setSuccessFor(price);
            ...
            if(brandValue === ''){
                //show error
                //add error class
                setErrorFor(brand, 'Select brand of product');
            }
            else{
                //add success class
                setSuccessFor(brand);
            ...
            if(nameValue === ''){
                //show error
                //add error class
                setErrorFor(name, 'Enter name of product');
            }
            else{
                //add success class
                setSuccessFor(name);
            ...
            if(imageInput.value===''){
                ...
                errorMessage.innerText = "Select a picture of the product";
            }
            else{
                imageContainer.style.border = "3px solid #7380ec";
            }

            if(nameValue !='' && brandValue !='' && priceValue !='' && categoryValue !='' && stockValue !='' && imageInput.value !=''){
