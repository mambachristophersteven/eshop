...
$total_price='¢'.$rowview['total_price'].'.00';
$status=$rowview['status'];
$customer=$rowview['customer'];
$telephone=$rowview['telephone'];
...
if(isset($_POST['submit'])){
    ...
    $sqlinsert= "UPDATE `orders` SET id='$id', status='Approved' WHERE id = '$id'";
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./ordersmanager.php" class="active">
        ...
        <main>
            ...
            <div class="form-format">  
                <div class="info-section">
                    ...
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $customer;?></strong></p>
                        <p>Customer Username</p>
                    </div>     
                    <br> 
                    <div class="info">
                        <p id="infos"><strong><?php echo $telephone;?></strong></p>
                        <p>Customer Telphone Number</p>
                    </div>                 
                </div>

                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Order Approval</h2>
                        ...
                        <div class="form-divisions">
                            <input type="submit" name="submit" value="Approve Order" id="submit">
                        </div>                         
                    </form>
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./dashboardmanager.php'">Cancel</button>
                        </div>
                </div>
            </div>
