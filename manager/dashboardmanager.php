...
$sqladmins= "SELECT * FROM `admins` WHERE position='Manager'";
$resultadmins= mysqli_query($con, $sqladmins);
$numadmins=mysqli_num_rows($resultadmins);  

$sqlcustomers= "SELECT * FROM `admins` WHERE position='Customer'";
$resultcustomers= mysqli_query($con, $sqlcustomers);
$numcustomers=mysqli_num_rows($resultcustomers);  

$sqlproducts= "SELECT * FROM `products`";
$resultproducts= mysqli_query($con, $sqlproducts);
$numproducts=mysqli_num_rows($resultproducts);  

$total_population= $numadmins + $numcustomers;


// <h3 class="message-count" id="message-count"><?php $sqldisplayp= "SELECT * FROM `new_applicants` WHERE status= 'pending'"; $resultdisplayp= mysqli_query($con, $sqldisplayp); $numdisplayp=mysqli_num_rows($resultdisplayp); echo $numdisplayp;
//   
...
<body onload="initClock()">
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./dashboardmanager.php" class="active">
        ...
        <main>
            ...
            <!-- <div class="search">
                <input type="search" name="search" id="" placeholder="search" autocomplete="off">
            ...
            <div class="insights">
                <div class="student-population">
                    ...
                    <small class="text-muted">total number of people with the company</small>
                </div>
                <!-- end of student population -->
                ...
                <div class="teaching-population">
                    ...
                    <small class="text-muted">total number of administrators</small>
                </div>
            ...
            <div class="recent">
                ...
                <a href="./customersmanager.php">Show All</a>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `orders` ORDER BY id DESC";
                        $resultdisplay= mysqli_query($con, $sqldisplay);
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                $id=$rowdisplay['id'];
                                $name=$rowdisplay['name'];
                                $quantity=$rowdisplay['quantity'];
                                $customer=$rowdisplay['customer'];
                                $total_price='¢'.$rowdisplay['total_price'].'.00';
                                ...
                                <tr>
                                    ...
                                    <td>$customer</td>
                                    <td>$status</td>
                                    <td><button id='view'  onclick=\"location.href = 'approveorder.php?viewid=".$id."'\">View</button></td>
                                </tr>
                ...
                <a href="./ordersmanager.php">Show All</a>
            </div>
        </main>
        <!-- end of main -->
        <div class="right">
