        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Access all data from orders list</h2>
                            <h1>Review Info</h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of orders with related info</h2>
                            <h1></h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">search through records of orders</small>
                </div>
                <!-- end of student population -->
