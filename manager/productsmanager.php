        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Access all data from products list</h2>
                            <h1>Review Info</h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of products with related info</h2>
                            <h1></h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">search through records of products</small>
                </div>
                <!-- end of student population -->
            ...
            <div class="recent">
                ...
                <h2>All Products</h2>
                <button id="add-new-applicant" onclick="location.href='./addnewproduct.php'">Add New Product</button>
