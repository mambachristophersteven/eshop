...
if(isset($_POST['submit'])){
    $review_reply=$_POST['review'];


    $sqlinsert= "UPDATE `orders` SET id='$id', admin_reply='$review_reply' WHERE id = '$id'";
    $resultin= mysqli_query($con, $sqlinsert);
    if($resultin){
        header("location: ./reviewsmanager.php");
        exit;
    }
    else{
        ...
        <main>
            ...
            <div class="form-format"> 
                <div class="info-section">
                    ...
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $quantity;?></strong></p>
                        <p>Quantity</p>
                    </div>   
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $total_price;?></strong></p>
                        <p>Total Price</p>
                    </div>  
                    <br>
                    <div class="info">
                        <p id="infos"><strong><?php echo $status;?></strong></p>
                        <p>Order Status</p>
                    </div>   
                    <br>   
                    <br>   
                    <div class="info">
                        <p id="infos"><strong><?php echo $review;?></strong></p>
                        <p>Last Customer Review</p>
                    </div>  
                    <br>   
                    <br>   
                    <div class="info">
                        <p id="infos"><strong><?php echo $reply;?></strong></p>
                        <p>Last Manager Reply</p>
                    </div>                 
                </div>

                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Reply Review Section</h2>
                        ...
                        <div class="form-divisions">
                            <input type="submit" name="submit" value="Submit Review" id="submit">
                        </div>                         
                    </form>
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./reviewsmanager.php'">Cancel</button>
                        </div>
                </div>
            </div>
    ...
    <script>
        ...
        function checkInputs(){
            ...
            if(reviewValue === ''){
                //show error
                //add error class
                setErrorFor(review, 'Enter review of order');
            }
            else{
                //add success class
