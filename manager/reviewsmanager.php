...
$sqlorders= "SELECT * FROM `orders` WHERE status='Approved'";
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./reviewsmanager.php" class="active">
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Access all data from reviews list</h2>
                            <h1>Review Info</h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of reviews with related info</h2>
                            <h1></h1>
                        </div>
                        <!-- <div class="progress">
                            <svg>
            ...
            <div class="recent">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `orders` WHERE status='Approved' ORDER BY id DESC";
                        ...
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                ...
                                $review=$rowdisplay['review'];
                                $reply=$rowdisplay['admin_reply'];
                                ...
                                <tr>
                                    ...
                                    <td>$review</td>
                                    <td>$reply</td>
                                    <td><button id='view'  onclick=\"location.href = 'replyreview.php?viewid=".$id."'\">Reply</button></td>
                                </tr>
